...
Public Class Product
	...
	Public Shared Function GetData() As List(Of Product)
		...
		products.Add(New Product() With {.ProductID = 7, .ProductName = "Uncle Bob's Organic Dried Pears", .UnitPrice = 30, .UnitsOnOrder = 0})
		products.Add(New Product() With {.ProductID = 8, .ProductName = "Northwoods Cranberry Sauce", .UnitPrice = 40, .UnitsOnOrder = 0})
		products.Add(New Product() With {.ProductID = 9, .ProductName = "Mishi Kobe Niku", .UnitPrice = 97, .UnitsOnOrder = 0})

		products.Add(New Product() With {.ProductID = 10, .ProductName = "Ikura", .UnitPrice = 31, .UnitsOnOrder = 0})
		products.Add(New Product() With {.ProductID = 11, .ProductName = "Queso Cabrales", .UnitPrice = 21, .UnitsOnOrder = 30})
